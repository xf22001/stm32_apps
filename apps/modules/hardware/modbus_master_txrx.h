 ...
 *   修改日期：2020年04月20日 星期一 17时29分18秒
 *   描    述：
 *
 *================================================================*/
...
int modbus_master_read_items(modbus_master_info_t *modbus_master_info, uint16_t addr, uint16_t *values, uint16_t number);
int modbus_master_write_one_item(modbus_master_info_t *modbus_master_info, uint16_t addr, uint16_t value);
int modbus_master_write_items(modbus_master_info_t *modbus_master_info, uint16_t addr, uint16_t *values, uint16_t number);

 ...
 *   修改日期：2020年04月20日 星期一 15时00分22秒
 *   描    述：
 *
 *================================================================*/
...
static int fn_0x03(modbus_slave_info_t *modbus_slave_info)//read some number
{
	...
	u_uint16_bytes.v = crc_check_for_dcph((uint8_t *)modbus_slave_response_0x03_head, (uint8_t *)modbus_crc - (uint8_t *)modbus_slave_response_0x03_head);
...
static int fn_0x06(modbus_slave_info_t *modbus_slave_info)//write one number
{
	...
	u_uint16_bytes.v = crc_check_for_dcph((uint8_t *)modbus_slave_response_0x06, (uint8_t *)modbus_crc - (uint8_t *)modbus_slave_response_0x06);
	modbus_crc->crc_l = u_uint16_bytes.s.byte0;
	modbus_crc->crc_h = u_uint16_bytes.s.byte1;
...
static int fn_0x10(modbus_slave_info_t *modbus_slave_info)//write more number
{
	...
	u_uint16_bytes.s.byte0 = modbus_crc->crc_l;
	u_uint16_bytes.s.byte1 = modbus_crc->crc_h;
	crc = crc_check_for_dcph((uint8_t *)modbus_slave_request_0x10_head, (uint8_t *)modbus_crc - (uint8_t *)modbus_slave_request_0x10_head);
	...
	u_uint16_bytes.v = crc_check_for_dcph((uint8_t *)modbus_slave_response_0x10, (uint8_t *)modbus_crc - (uint8_t *)modbus_slave_response_0x10);
	modbus_crc->crc_l = u_uint16_bytes.s.byte0;
	modbus_crc->crc_h = u_uint16_bytes.s.byte1;

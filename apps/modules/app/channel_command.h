...
typedef struct {
	...
	uint8_t channel_max_output_power_l;//通道最大输出功率
	uint8_t channel_max_output_power_h;//通道最大输出功率
...
typedef struct {
	uint8_t cmd;//6
	uint8_t max_charge_voltage_single_battery_l;//单体最高允许电压 max_charge_voltage_single_battery
	uint8_t max_charge_voltage_single_battery_h;//单体最高允许电压 max_charge_voltage_single_battery

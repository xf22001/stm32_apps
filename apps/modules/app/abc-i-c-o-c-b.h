 ...
 *   修改日期：2020年05月09日 星期六 15时19分34秒
 *   描    述：
 *
 *================================================================*/
#ifndef _ABC-I-C-O-C-B_H
#define _ABC-I-C-O-C-B_H
#ifdef __cplusplus
extern "C"
{
#endif
...
typedef enum {
	abc_i_c_o_c_b_fn_a_phase_line_voltage = 256,//1v
	abc_i_c_o_c_b_fn_b_phase_line_voltage = 257,//1v
	abc_i_c_o_c_b_fn_c_phase_line_voltage = 258,//1v
	abc_i_c_o_c_b_fn_phase_average_voltage = 259,//1v
	abc_i_c_o_c_b_fn_ab_line_voltage = 260,//1v
	abc_i_c_o_c_b_fn_bc_line_voltage = 261,//1v
	abc_i_c_o_c_b_fn_ca_line_voltage = 262,//1v
	abc_i_c_o_c_b_fn_line_average_voltage = 263,//1v
	abc_i_c_o_c_b_fn_a_phase_current = 268,//1a
	abc_i_c_o_c_b_fn_b_phase_current = 269,//1a
	abc_i_c_o_c_b_fn_c_phase_current = 270,//1a
	abc_i_c_o_c_b_fn_a_phase_current_unevenness_rate = 275,//1%
	abc_i_c_o_c_b_fn_b_phase_current_unevenness_rate = 276,//1%
	abc_i_c_o_c_b_fn_c_phase_current_unevenness_rate = 277,//1%
	abc_i_c_o_c_b_fn_max_current_unevenness_rate = 278,//1%
} abc_i_c_o_c_b_fn_t;
...
} abc_i_c_o_c_b_reg_offset_512_t;
...
} abc_i_c_o_c_b_reg_offset_513_t;
...
} abc_i_c_o_c_b_reg_offset_514_t;
...
} abc_i_c_o_c_b_reg_offset_515_t;

#ifdef __cplusplus
}
#endif
//intelligent controller of circuit breaker
#endif //_ABC-I-C-O-C-B_H

 ...
 *   修改日期：2021年07月06日 星期二 11时31分51秒
 *   描    述：
 *
 *================================================================*/
...
typedef enum {
	...
	CHANNEL_RECORD_ITEM_STOP_REASON_CHANNELS_FAULT,
	CHANNEL_RECORD_ITEM_STOP_REASON_CHANNEL_FAULT,
} channel_record_item_stop_reason_t;

typedef enum {
	CHANNEL_RECORD_CHARGE_MODE_NONE = 0,
